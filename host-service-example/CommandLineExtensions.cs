...
namespace ServiceExample
{
    ...
    {
        /// <summary>
        ///     Undo the processing which took place to create string[] args in ServiceBase.OnStart and Main, so that the next process will
        ...
        public static string EscapeArguments(this string[] args) => string.Join(" ", args.Select(EscapeSingleArg));
